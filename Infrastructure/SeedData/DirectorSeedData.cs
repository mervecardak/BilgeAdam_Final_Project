        ...
        public void Configure(EntityTypeBuilder<Director> builder)
        {
            builder.HasData
                (
                    ...
                    new Director { Id = 2, FirstName = "Roman", LastName = "Polanski", BirthDate = new DateTime(1933, 08, 18) },
                    new Director { Id = 3, FirstName = "Quentin Jerome", LastName = "Tarantino", BirthDate = new DateTime(1963, 03, 27) },
