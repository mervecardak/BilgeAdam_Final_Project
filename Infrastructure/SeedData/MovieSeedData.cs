    ...
    public class MovieSeedData : IEntityTypeConfiguration<Movie>
    {
        public void Configure(EntityTypeBuilder<Movie> builder)
        {
            builder.HasData
                ...
                new Movie { Id = 4, DirectorId = 2, Name = "An Officer and A Spy", Year = 2019, Description = "In 1894, French Captain Alfred Dreyfus is wrongfully convicted of treason and sentenced to life imprisonment at Devil's island.", Image = "noimage.png" },
